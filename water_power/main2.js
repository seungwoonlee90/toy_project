...
window.onload = function(){
    ...
    let obscd = 'https://raw.githubusercontent.com/seungwoonlee90/toy_project/master/water_power/obscd.csv';
    axios.request(obscd).then(function(res) {
        let obscds = res.data.obscd;
        console.log(obscds);
    })
}
